...
namespace ParcelDeliveryTrackingAPI.Controllers
{
    ...
    public class PersonnelController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<Delivery>>> GetAllPersonnel()
        {
        ...
        [EnableCors("AllowOrigin")]
        [HttpGet("{id}")]
        public async Task<ActionResult<Delivery>> GetPersonnelById(int id)
        {
        ...
        [EnableCors("AllowOrigin")]
        [HttpGet("fullname")]
        public async Task<ActionResult<IEnumerable<Delivery>>> GetPersonnelByFullName([FromQuery] string firstName, [FromQuery] string lastName)
        {
        ...
        [EnableCors("AllowOrigin")]
        [HttpGet("onduty")]
        public async Task<ActionResult<List<Delivery>>> GetPersonnelOnDuty()
        {
        ...
        [EnableCors("AllowOrigin")]
        [HttpGet("offduty")]
        public async Task<ActionResult<List<Delivery>>> GetPersonnelOffDuty()
        {
